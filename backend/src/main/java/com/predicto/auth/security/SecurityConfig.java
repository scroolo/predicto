    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/admin/academy/**").hasRole("ADMIN")
                ...
                .requestMatchers("/api/academy/progress").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/academy/lessons/*/complete").authenticated()
                .requestMatchers("/api/academy/courses/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/academy/lessons/**").permitAll()
